...
function getWebsitesTitles(addresses, callBack)
{
...
module.exports = {
    handleRequest: function(req, res){
        ...
        {
            var getWebsitesTitlesObservable = Observable.bindCallback(getWebsitesTitles);

            getWebsitesTitlesObservable(q.query.address)
                .subscribe(liData => {
