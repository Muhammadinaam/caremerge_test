...
function getWebsitesTitlesAndSendResponse(addresses, res, callback)
{
...
module.exports = {
    handleRequest: function(req, res){
        ...
        {
            getWebsitesTitlesAndSendResponse(q.query.address, res, sendHTMLResponseWithWebsiteTitles);
        }
        else
        {
